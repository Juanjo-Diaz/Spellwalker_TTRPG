...
1. ## **Descripción**
   * *Spellwalker* es un juego de rol de tipo de fantasía-ciencia ficción, el cual se basa en un universo que combina elementos de fantasía (rituales mágicos, criaturas mitológicas, etc.) con tecnología avanzada y elementos de ciencia ficción (espacio, tecnología futurista, etc.).
   ...
   En este juego también se recompensa la creatividad del jugador, ya que los jugadores pueden "romper" la regla no escrita de que una "clase" (es decir, un tipo de personaje) debe de usar ciertos elementos o tipos de habilidades.
   También se recompensa que los jugadores busquen "sinergias" entre los distintos elementos del juego, ya que pueden generar interacciones inesperadas, lo que crea situaciones que rompen la monotonía del juego.
